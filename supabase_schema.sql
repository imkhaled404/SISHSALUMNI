...
CREATE TABLE IF NOT EXISTS committee (id SERIAL PRIMARY KEY, member_id INTEGER REFERENCES members(id) ON DELETE SET NULL, role TEXT NOT NULL, year TEXT NOT NULL, passing_year TEXT, biography TEXT, message TEXT, sort_order INTEGER NOT NULL DEFAULT 0);
